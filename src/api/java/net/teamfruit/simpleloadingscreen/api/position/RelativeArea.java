...
public class RelativeArea {
	 ...
	 */
	protected @Nullable RelativeArea parent;
	/**
	 * 1つ目のX相対座標
	 */
	 ...
	 */
	public RelativeArea(final @Nonnull Coord... a) throws IllegalStateException {
		for (final Coord c : a)
			if (c!=null)
				set(c);
	}
	 ...
	 * @throws IllegalStateException 各座標系がそれぞれ3つ以上、または幅、高さが2つ以上指定された場合。
	 */
	public RelativeArea(final @Nonnull RelativeArea parent, final @Nonnull Coord... a) throws IllegalStateException {
		this(a);
		setParent(parent);
	}
	 ...
	 * @param a 相対座標
	 */
	public RelativeArea(final @Nonnull RelativeArea a) {
		set(a);
	}
	 ...
	 * @param a 相対座標
	 */
	public RelativeArea(final @Nonnull RelativeArea parent, final @Nonnull RelativeArea a) {
		this(a);
		setParent(parent);
	}
	 ...
	 * @param parent
	 */
	protected void setParent(final @Nonnull RelativeArea parent) {
		this.parent = parent;
	}
	 ...
	 * @param a 相対範囲
	 */
	protected void set(final @Nonnull RelativeArea a) {
		this.x1 = a.x1;
		this.y1 = a.y1;
		this.x2 = a.x2;
		this.y2 = a.y2;
	 ...
	 * @return 相対範囲
	 */
	public @Nonnull RelativeArea child(final @Nonnull Coord... a) {
		return new RelativeArea(this, a);
	}
	 ...
	 * @return 相対範囲
	 */
	public @Nonnull RelativeArea child(final @Nonnull RelativeArea a) {
		return new RelativeArea(this, a);
	}
